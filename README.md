...
- For the primary keys, verify that the column is unique. Otherwise, create a composite key to an external site., which takes two primary keys to uniquely identify a row.
